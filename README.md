This repo is being archived.  Although json validation functionality is complete, implementation through nwscript is far too slow and uses too many instructions.  This repo will remain publicly arhived.  In its stead, an NWNX_SCHEMA plugin is being developed that is much more capable and far more efficient.
